 ...
 * @author mig_2
 */
@WebServlet(name = "EditarProductoFinalServlet", urlPatterns = {"/editar-producto-final"})
public class EditarProductoFinalServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usuario != null && usuario instanceof Administrador) {
            ...
            Producto producto = new Producto(id, nombre, nombreImagen, precio);
